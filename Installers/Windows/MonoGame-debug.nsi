...
OutFile 'MonoGameSetup-debug.exe'
...
Section "MonoGame Core Components" CoreComponents ;No components page, name is not important
  ...
  File /r '..\..\Tools\2MGFX\bin\Windows\AnyCPU\Debug\*.exe'
  File /r '..\..\Tools\2MGFX\bin\Windows\AnyCPU\Debug\*.dll'
  File /r '..\..\Tools\MGCB\bin\Windows\AnyCPU\Debug\*.exe'
  File /r '..\..\Tools\MGCB\bin\Windows\AnyCPU\Debug\*.dll'
  File /r '..\..\Tools\Pipeline\bin\Windows\AnyCPU\Debug\*.exe'
  File /r '..\..\Tools\Pipeline\bin\Windows\AnyCPU\Debug\*.dll'
  File /r '..\..\Tools\Pipeline\bin\Windows\AnyCPU\Debug\Templates'
  ...
  File /nonfatal '..\..\MonoGame.Framework\bin\WindowsGL\AnyCPU\Debug\*.dll'
  File /nonfatal '..\..\MonoGame.Framework\bin\WindowsGL\AnyCPU\Debug\*.pdb'
  File /nonfatal ' ..\..\MonoGame.Framework\bin\WindowsGL\AnyCPU\Debug\*.xml'
  ...
  File '..\..\MonoGame.Framework\bin\Windows\AnyCPU\Debug\*.dll'
  File '..\..\MonoGame.Framework\bin\Windows\AnyCPU\Debug\*.pdb'
  File '..\..\MonoGame.Framework\bin\Windows\AnyCPU\Debug\*.xml'
  ...
  File '..\..\MonoGame.Framework\bin\Windows8\AnyCPU\Debug\*.dll'
  File '..\..\MonoGame.Framework\bin\Windows8\AnyCPU\Debug\*.pdb'
  File '..\..\MonoGame.Framework\bin\Windows8\AnyCPU\Debug\*.xml'

    ; Install Windows Phone 8.1 Assemblies
  SetOutPath '$INSTDIR\Assemblies\WindowsPhone81'
  File '..\..\MonoGame.Framework\bin\WindowsPhone81\AnyCPU\Debug\*.dll'
  File '..\..\MonoGame.Framework\bin\WindowsPhone81\AnyCPU\Debug\*.pdb'
  File '..\..\MonoGame.Framework\bin\WindowsPhone81\AnyCPU\Debug\*.xml'

  ; Install Windows Phone ARM Assemblies
  SetOutPath '$INSTDIR\Assemblies\WindowsPhone\ARM'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\ARM\Debug\*.dll'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\ARM\Debug\*.pdb'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\ARM\Debug\*.xml'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\ARM\Debug\*.winmd'

  ; Install Windows Phone x86 Assemblies
  SetOutPath '$INSTDIR\Assemblies\WindowsPhone\x86'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\x86\Debug\*.dll'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\x86\Debug\*.pdb'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\x86\Debug\*.xml'
  File '..\..\MonoGame.Framework\bin\WindowsPhone\x86\Debug\*.winmd'
